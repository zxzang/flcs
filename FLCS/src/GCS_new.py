...
class MyForm(QtGui.QMainWindow):
    ...
    def checkData(self):
	'''funkcja bwdzie sprwdzac czy dane  do testow zostaly wczytane'''
	...
	self.FLCS.getGrammar().parametry.fuzzyUnion = self.ui.comboBoxUnion.currentText()
	self.FLCS.getGrammar().parametry.memebershipFunction = self.ui.comboBoxMembership.currentText()
	...
	''' funkcja bedzie dodawac dodatkowe cobosy w oknie'''
