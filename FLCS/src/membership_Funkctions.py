...
class membershipOperations():
    ...
    def countMembership(self):
        '''tutaj bedzie juz liczone to co tzeba, nie wiem jeszcze co dokaldnie tutaj bedize potrzbne do przekazania'''
...
cos = membershipOperations("assa")
print cos.countMembership()
